...
export default function ComplaintForm({ onSubmit, isLoading, appConfig }: ComplaintFormProps) {
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative p-8 sm:p-10 bg-white dark:bg-slate-950 rounded-[1.5rem] border border-slate-200/60 dark:border-slate-800 shadow-2xl overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="space-y-1">
              ...
              <div className="relative group/text">
                ...
                <textarea
                  ...
                  rows={4}
                  className={cn(inputClasses, "resize-none h-32 py-4")}
                  required
                />
              </div>
            </div>
          ...
          <div className="pt-2">
            ...
            >
              <div className="relative flex items-center justify-center gap-3 rounded-[0.9375rem] bg-slate-950 dark:bg-brand-accent px-8 py-5 text-white transition-all group-hover:bg-transparent dark:group-hover:bg-blue-700">
                {isLoading ? (
                  <>
