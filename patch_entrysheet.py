...
start_marker = "      // Step 3: Run connected recovery sheet matching/updating using the updated/linked sheet rows"
end_marker = "      // --- INSTANT OPTIMISTIC UI STATE SYNCHRONIZATION ---"

if start_marker in content and end_marker in content:
    before = content.split(start_marker)[0]
    after = content.split(end_marker)[1]
    
    new_logic = """      // Step 3: Run connected recovery sheet matching/updating using the updated/linked sheet rows
    ...
    print("Successfully patched EntrySheet.tsx")
else:
